...
@section('content')
    {{-- <div class="text-center sales d-none">
        <h1>Receving Report</h1>
    </div>
    <div class="row">
        <div class="col-12">
            <div class="btn-toolbar d-md-flex justify-content-md-end">
                <a href="{{ url('/receiving') }}" class=" btn mybtn-info fw-light"><i class="fas fa-cart-arrow-down"></i>
                    &nbsp;
                    Receving Register</a>
                @if (count($all_receiving) > 0)
                    @isset($all_receiving)
                    ...
                    <tbody>
                        @forelse($all_receiving as $sale)
                            <tr>
                                ...
                                <td id="action">
                                    <a href="{{ route('receiving.invoice', ['id' => $sale->id]) }}"
                                        class="btn btn-info"><i class="fas fa-download"></i></a>
                                    <a onclick="return confirm('are you sure to delete this data?')"
                                        href="{{ route('receiving.destroy', ['id' => $sale->id]) }}"
                                        class="btn btn-info"><i class="fas fa-trash"></i></a>
                                </td>
                            </tr>
                        @empty
                            <tr>

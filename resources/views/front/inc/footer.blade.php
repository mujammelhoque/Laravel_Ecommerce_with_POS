        ...
        <div class="container">
            <div class="row">
                <div class="companyinfo">
                    <a href="index.html">
                        <img src="{{ asset('front/') }}/img/logo-b.png"
                ...
                <div class="f-block-list">
                    <div class="f-block-wrap">
                        <div class="f-block">
                            <a href="index.html#" class="f-block-btn" data-id="#f-block-modal-1">
                                <div class="iframe-img">
                                    <img src="{{ asset('front/') }}/img/footer/1.jpg" alt="About us">
                                </div>
                    ...
                    <div class="f-block-wrap">
                        <div class="f-block">
                            <a href="index.html#" class="f-block-btn" data-id="#f-block-modal-2">
                                <div class="iframe-img">
                                    <img src="{{ asset('front/') }}/img/footer/2.jpg" alt="Ask questions">
                                </div>
                                <div class="overlay-icon">
                    ...
                    <div class="f-block-wrap">
                        <div class="f-block">
                            <a href="index.html#" class="f-block-btn" data-id="#f-block-modal-3"
                                ...
                                <div class="iframe-img">
                                    <img src="{{ asset('front/') }}/img/footer/3.jpg" alt="Video (2 min)">
                                </div>
                                <div class="overlay-icon">
                    ...
                    <div class="f-block-wrap">
                        <div class="f-block">
                            <a href="index.html#" class="f-block-btn" data-id="#f-block-modal-4">
                                <div class="iframe-img">
                                    <img src="{{ asset('front/') }}/img/footer/4.jpg" alt="Our address">
                                </div>
                                <div class="overlay-icon">
                ...
                <div class="stylization f-block-modal f-block-modal-content" id="f-block-modal-1">
                    ...
                    Lorem ipsum dolor sit amet, consectetur adipisicing elit. Nam natus iste ullam vero, tenetur ab ipsa
                    consectetur deleniti officiis ex debitis incidunt alias voluptatum, maxime placeat dolores veniam
                    sunt at atque velit, soluta. Neque ea alias quia provident molestias, ratione aut esse placeat
                    beatae sequi sed laudantium. Unde animi nihil esse, repellendus exercitationem dicta harum ab
                    labore, voluptates explicabo in, quidem dolorum voluptas!
                </div>
                ...
                <div class="stylization f-block-modal f-block-modal-map" id="f-block-modal-4">
                    <div class="allstore-gmap">
                        <div class="marker" data-zoom="15" data-lat="-37.81485261872975"
                            data-lng="144.95655298233032" data-marker="img/marker.png">534-540 Little Bourke St,
                            Melbourne VIC 3000, Australia</div>
                    </div>
                </div>
                <div class="f-delivery">
                    <img src="{{ asset('front/') }}/img/map.png" alt="">
                    <h4>Free delivery in Dhaka</h4>
        ...
        <div class="row">
            ...
            <div class="f-menu">
                ...
                <ul class="nav nav-pills nav-stacked">
                    ...
                    <li><a href="http://allstore-html.real-web.pro/reviews.html">Reviews</a></li>
            ...
            <div class="f-subscribe">
                ...
                <form class="f-subscribe-form" action="index.html#">
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="footer-copyright">
                    <i><a href="#">WDPF - Round-45</a></i> © Copyright 2021
                </div>
            </div>
        </div>
    </div>
...
<script type="text/javascript">
    (function(d, w, c) {
        (w[c] = w[c] || []).push(function() {
            try {
                w.yaCounter42088244 = new Ya.Metrika({
                    id: 42088244,
                    clickmap: true,
                    trackLinks: true,
    ...
    <div><img src="https://mc.yandex.ru/watch/42088244" style="position:absolute; left:-9999px;" alt="" /></div>
...
<script>
    $(document).ready(function() {
        $(document).ready(function() {
            $('form.topsearch-form').on('submit', function(e) {
                e.preventDefault();
                var search = $('#search').val();
                var url = '{{ url('s/') }}' + '/' + search
